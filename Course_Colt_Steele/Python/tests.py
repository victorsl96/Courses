...
class CardTests(unittest.TestCase):
	...
	def test_repr(self):
		"""repr should return a string like 'value of suit'"""
...
class DeckTests(unittest.TestCase):
	...
	def test_init(self):
		"""Decks should have a cards atribute"""
		self.assertTrue(isinstance(self.deck.cards), list)
		self.assertEqual(len(self.deck.cards), 52)

	def test_repr(self):
		"""repr should return a string like 'Deck of 52 cards'"""
